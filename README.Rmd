...
Everyday ggplot2 extension is a resource for people that want to get into ggplot2 extension but might not be confident of how to do so ('absolute newcomers').
...
If after browsing extension others have provided, the [extensions gallery](https://exts.ggplot2.tidyverse.org/gallery/)
and the [Awesome `ggplot2`](https://github.com/erikgahner/awesome-ggplot2) repository, you can't find what you need to fly again, you can consider doing your own extension.
